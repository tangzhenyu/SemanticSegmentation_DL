...
class FCN8s(Network):
    def __init__(self, is_training=False, num_classes=151, input_size=[384, 384]):
        ...
        #self.label = tf.placeholder(dtype=tf.float32, shape=[None, None, 3])
...
class ICNet(Network):
    ...
    def setup(self, is_training, num_classes):
        ...
        sub4_out = self.layers['sub4_out']
        sub24_out = self.layers['sub24_out']
        sub124_out = self.layers['conv6_cls']
